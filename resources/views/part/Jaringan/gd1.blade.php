            ...
            <div class="container px-0 mx-auto ">
                <div class="row fs-6">
                    <div class="col info-item-wraping">
                        ...
                        <p class="jaringantext ">{{ $jargd1->ap == 0 ? '-' : $jargd1->ap }} AP</p>
                    </div>
                    <div class="col info-item-wraping">
                        <i class="fa-solid fa-download logow "></i>
                        <!-- <p class="jaringantext"> - Mbps</p> -->
                        <p class="jaringantext">{{ $jargd1->download == 0.0 ? '-' : $jargd1->download }} Mbps</p>
                    </div>
                    <div class="col info-item-wraping">
                        <i class="fa-solid fa-upload logow"></i>
                        <!-- <p class="jaringantext"> - Mbps</p> -->
                        <p class="jaringantext">{{ $jargd1->upload == 0.0 ? '-' : $jargd1->upload }} Mbps</p>
                    </div>
                </div>
            </div>
        </div>
